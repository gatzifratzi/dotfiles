...
# ctrl-j/k/n/p zum navigieren. Tab/shift-tab zum markieren
# Set up fzf key bindings and fuzzy completion
source <(fzf --zsh)
# macht fzf schoener
export FZF_DEFAULT_OPTS="--style full --layout reverse --preview 'fzf-preview.sh {}' -m --pointer ▶ --marker ⇒"
# default fzf command (fd anstatt find)
export FZF_DEFAULT_COMMAND="fd --hidden --strip-cwd-prefix --exclude .git"
# ctrl-t command
export FZF_CTRL_T_COMMAND="$FZF_DEFAULT_COMMAND" #fd anstatt find
#alt-c command (sucht nur dirs)(fd anstatt find)
export FZF_ALT_C_COMMAND="fd --type=d --hidden --strip-cwd-prefix --exclude .git"
# glaub das ist fuer fuzzy completion (**)
_fzf_compgen_path() {
